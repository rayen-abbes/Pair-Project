function remove_img() {
  ...
  document.getElementById('music').innerHTML = '<audio autoplay><source src="song.mp3" type="audio/mpeg"></audio>'
...
function checkWinner() {
  ...
  document.getElementById('music1').innerHTML = '<audio autoplay><source src="song2.mp3" type="audio/mpeg"></audio>'
